      ...
      <div className="container footer">
        <div>
          ...
          <div className="footerContacts">
            <h4>Get In Touch</h4>
            <ul>
              <li>Business name: CloClips</li>
              <li>
                Email:&nbsp;
                <a href="mailto:support@cloclips.shop">support@cloclips.shop</a>
              </li>
              <li>
                Call: <a href="tel:+375444906872">+375444906872</a>
              </li>
              <li>Operating Hours: Mon - Sun | 10:00 to 18:00 (EST)</li>
              <li>
                Business address: 71 Rue Porchefontaine, 94370 Sucy-en-Brie,
                France
              </li>
            </ul>
